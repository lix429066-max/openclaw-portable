...
export function checkPermissions(
  ...
  if (name === "cache" || name === "cc_context" || name === "cc_doctor" || name === "cc_status" || name === "cc_help" || name === "cc_diff" || name === "cc_lint" || name === "cc_config" || name === "session_note" || name === "todo_write" || name === "cc_question") {
